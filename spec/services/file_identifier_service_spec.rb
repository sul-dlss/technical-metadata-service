...
RSpec.describe FileIdentifierService do
  ...
  describe '#identify' do
    let(:mimetype) { service.identify(filepath: 'bar.txt') }
    ...
    context 'when siegfried fails' do
      ...
      it 'raises' do
        expect { mimetype }.to raise_error(FileIdentifierService::Error)
      end
    end
